...
This document is the canonical description of the SieveRuler rules contract,
composition behavior, and generated provider metadata.
...
which lets provider rule editors associate names and stable IDs with the generated rules.
